...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://638ef0c14ddca317d7e9e0d8.mockapi.io/tyrs')
            const cartData = await axios.get('https://638ef0c14ddca317d7e9e0d8.mockapi.io/cart')
            const favoritesData = await axios.get('https://638ef0c14ddca317d7e9e0d8.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://638ef0c14ddca317d7e9e0d8.mockapi.io/cart/${id}`)
